		...
		if (myCommandsWindow == nil) then
			...
			local commands =
			{
				-- FIXME: Order each tab's contents (alphabetically)
				{
					...
					{ "/tuneradio", "/tuneradio [frequency]", "Tunes a radio on a frequency, allowing you to speak with everyone using the same frequency.", "/tuneradio 100" },
					{ "/toggleradio", "/toggleradio", "Turns your radio on/off.", "/toggleradio" },
