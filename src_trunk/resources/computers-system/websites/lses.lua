...
function www_lses_gov()
	...
	local link_4 = guiCreateLabel(236,10,72,16,"Affiliates",false,bg)
	...
	addEventHandler("onClientGUIClick",link_4,function()
		local url = tostring("www.LSES.gov/Affiliates") -- Put hyperlink url in quotation marks
		get_page(url)
	end,false)
	
	local link_end_bg = guiCreateStaticImage(312,4,148,24,"websites/colours/3.png",false,bg)
	local url_label_shadow = guiCreateLabel(325,11,130,16,"LSES.gov",false,bg)
	guiLabelSetColor(url_label_shadow,30,30,30)
	guiLabelSetHorizontalAlign(url_label_shadow,"center")
	local url_label = guiCreateLabel(324,10,130,16,"LSES.gov",false,bg)
	...
	local header_label = guiCreateLabel(15,38,300,16,"Los Santos Emergency Services",false,bg)
	...
	-- Content --
	-------------
	local side_text = guiCreateLabel(10,110,105,120,"John Brenkly\
												\
												Enjoy your stay\
												24/11/1988\
												\
												Occupation:\
												LSES Deputy",false,bg)	
	-- Header 1
	...
	local header_2 = guiCreateLabel(131,170,200,16,"And you are...?",false,bg)
	local para2 = guiCreateLabel(128,194,329,70,"Who and what are we? We are the medical and fire team, out there to help keep your lives safe. ",false,bg) 
	...
	local header_3 = guiCreateLabel(131,270,200,16,"Location?",false,bg)
	local para3 = guiCreateLabel(128,294,329,70,"Where can we be found? We can normally be found obvious at the Hospital and Fire Department, situated in Market. ",false,bg) 
