...
function www_izanagi_sa()
	...
	local list1 = guiCreateLabel(160,104,350, 16, "Yoshitsune Enterprises",false,bg)
	guiLabelSetColor(list1, 0,0,0)
	guiLabelSetHorizontalAlign(list1, "center")
	guiSetFont(list1, "default-normal")
	
	local list2 = guiCreateLabel(160,120,350, 16, "www.yoshitsuneenterprises.sa",false,bg)
	guiLabelSetColor(list1, 0,0,0)
	guiLabelSetHorizontalAlign(list1, "center")
	guiSetFont(list1, "default-normal")
	
	local list3 = guiCreateLabel(160,152,350, 16, "Gnocchi Ristorante",false,bg)
	guiLabelSetColor(list1, 0,0,0)
	guiLabelSetHorizontalAlign(list1, "center")
	guiSetFont(list1, "default-normal")
	
	local list4 = guiCreateLabel(160,168,350,16, "www.gnocchi.sa",false,bg)
	guiLabelSetColor(list2, 0,0,0)
	guiLabelSetHorizontalAlign(list2, "center")
	guiSetFont(list2, "default-small")

	local list5 = guiCreateLabel(160,200,350, 16, "Bibles",false,bg)
	guiLabelSetColor(list3, 0,0,0)
	guiLabelSetHorizontalAlign(list3, "center")
	guiSetFont(list3, "default-normal")
	
	local list6 = guiCreateLabel(160,216,350,16, "www.bibles.sa",false,bg)
	...
	addEventHandler("onClientGUIClick",list1,function()
		local url = tostring("www.yoshitsuneenterprises.sa")
		get_page(url)
	end,false)
	...
	addEventHandler("onClientGUIClick",list5,function()
