...
function www_midoruenterprises_sa()
	...
	local bg_2 = guiCreateStaticImage(58,20,350,745,"websites/colours/1.png",false,bg)
	
	local title_shadow = guiCreateLabel(41,24,350,45,"Midoru Enterprises",false,bg)
	guiLabelSetHorizontalAlign(title_shadow,"center")
	guiSetFont(title_shadow,"sa-header")
	guiLabelSetColor(title_shadow,28,28,28)
	
	local title = guiCreateLabel(40,23,350,45,"Midoru Enterprises",false,bg)
	...
	-- Navigation bar --
	--------------------
	local nav_bar = guiCreateStaticImage(0,90,460,18,"websites/colours/44.png",false,bg)
	
	-- Link 1
	local link_1 = guiCreateLabel(69,90,72, 16,"- Home -",false,bg)
	...
	-- Link 2
	local link_2_shadow = guiCreateLabel(149,91,72,16,"Contact Us",false,bg)
	guiLabelSetColor(link_2_shadow,28,28,28)
	local link_2 = guiCreateLabel(148,90,72, 16,"Contact Us",false,bg)
	guiLabelSetHorizontalAlign(link_2_shadow, "center")
	...
	-- Link 3
	local link_3_shadow = guiCreateLabel(229,91,72,16,"Properties",false,bg)
	guiLabelSetColor(link_3_shadow,28,28,28)
	local link_3 = guiCreateLabel(228,90,72, 16,"Properties",false,bg)
	guiLabelSetHorizontalAlign(link_3_shadow, "center")
	...
	-- Link 4
	local link_4_shadow = guiCreateLabel(309,91,86,16,"Employment",false,bg)
	guiLabelSetColor(link_4_shadow,28,28,28)
	local link_4 = guiCreateLabel(308,90,86, 16,"Employment",false,bg)
	guiLabelSetHorizontalAlign(link_4_shadow, "center")
	...
	local designer_link = guiCreateStaticImage(319,286,146,110, "websites/images/izanagi/izanagi-green.png", false, bg)
	...
	-- Content --
	-------------
	local title_1 = guiCreateLabel(70,128,86,16,"Welcome",false,bg)
	guiLabelSetColor(title_1,16,64,16)
	local text_1 = guiCreateLabel(79,144,301,128,"Welcome to the official website of Midoru Enterprises, if you are looking for a well paid job, or just want to know where are our fun facilities are located, you are at the right place , please feel free to browse among our website.",false,bg)
...
function www_midoruenterprises_sa_contact()
	...
	-- Link 1
	local link_1_shadow = guiCreateLabel(70,91,72,16,"Home",false,bg)
	guiLabelSetColor(link_1_shadow,28,28,28)
	local link_1 = guiCreateLabel(69,90,72, 16,"Home",false,bg)
	guiLabelSetHorizontalAlign(link_1_shadow, "center")
	guiLabelSetHorizontalAlign(link_1, "center")
		addEventHandler("onClientGUIClick",link_1,function()
		local url = tostring("www.midoruenterprises.sa")
		get_page(url)
	...
	-- Content --
	-------------
	local title_1 = guiCreateLabel(70,128,330,16,"Ways to contact us",false,bg)
	guiLabelSetColor(title_1,16,64,16)
	local text_1 = guiCreateLabel(79,144,301,64,   "E-Mail : MidoruEnterprises@whiz.sa\
...
function www_midoruenterprises_sa_props()
	...
	-- Link 4
	local link_4_shadow = guiCreateLabel(309,90,72, 16,"Employment",false,bg)
	guiLabelSetColor(link_4_shadow,28,28,28)
	local link_4 = guiCreateLabel(308,90,86, 16,"Employment",false,bg)
	guiLabelSetHorizontalAlign(link_4_shadow, "center")
	guiLabelSetHorizontalAlign(link_4, "center")
	...
	-- Content --
	-------------
	local title_1 = guiCreateLabel(70,128,330,16,"Properties",false,bg)
	guiLabelSetColor(title_1,16,64,16)
	local text_1 = guiCreateLabel(79,144,301,32,"Midoru Enterprises facilities throughout Los Santos",false,bg)
	guiLabelSetColor(text_1,28,28,28)
	guiLabelSetHorizontalAlign(text_1,"left",true)
	
	local title_2 = guiCreateLabel(70,176,330,16,"Club Akai",false,bg)
	guiLabelSetColor(title_2,16,64,16)
	local text_2 = guiCreateLabel(79,192,301,32,"Best club in Los Santos, it's a big square orange building located at W. Broadway, east of the LS Bank",false,bg)
	guiLabelSetColor(text_2,28,28,28)
	guiLabelSetHorizontalAlign(text_2,"left",true)
		
	local title_3 = guiCreateLabel(70,224,330,16,"Midoru no Diner",false,bg)
	guiLabelSetColor(title_3,16,64,16)
	local text_3 = guiCreateLabel(79,240,330,32,"Cheap but high quality food here at Midoru no Dinner, located west of the Vinewood Gas Station.",false,bg)
	guiLabelSetColor(text_3,28,28,28)
	guiLabelSetHorizontalAlign(text_3,"left",true)
			
	local title_4 = guiCreateLabel(70,272,330,16,"Midoru no Casino",false,bg)
	guiLabelSetColor(title_4,16,64,16)
	local text_4 = guiCreateLabel(79,288,330,256,"This by far is the greatest Casino in Los Santos after The Starlight Casino, it is located West of the LS bank, at the exterior we have a fabulous Cafe serving only the best coffee, tea, you could even have a luxury desert here, in the interior, we have a great bar, serving drinks from all around the world, from Sake to Vodka, we also have great starts by our weekly car prize, high quality security and employees, best place to gamble in.",false,bg)
...
function www_midoruenterprises_sa_employ()
	...
	-- Content --
	-------------
	local title_1 = guiCreateLabel(70,128,330,16,"Employment",false,bg)
	guiLabelSetColor(title_1,16,64,16)
	local text_1 = guiCreateLabel(79,144,301,32,"Currently we are hiring young experienced Guards, also are looking for professional Managers for our facilities, for more information, E-Mail the CEO at \" K.Midoru@saonline.sa \".",false,bg)
	guiLabelSetColor(text_1,28,28,28)
	guiLabelSetHorizontalAlign(text_1,"left",true)
